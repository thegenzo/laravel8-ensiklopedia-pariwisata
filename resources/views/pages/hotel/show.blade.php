          ...
          <div class="col-lg-12 posts-list">
             <div class="single-post">
                <div class="feature-img">
                   <img class="img-fluid" src="{{ asset('foto-hotel/'.$hotel->sampul_hotel) }}" alt="">
                </div>
                ...
                <div class="row mt-5 mb-5">
                    <div class="col-md-12">
                        <h3 class="text-center">Harga kamar rata-rata</h3>
                        <h2 class="text-center">Rp. {{ number_format($hotel->harga_rata) }}</h2>
                    </div>
                </div>
                <hr>
                <div class="row mt-5 mb-5">
