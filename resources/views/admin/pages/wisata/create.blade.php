    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Masukkan data wisata</h4>
            </div>
            <div class="card-body">
                @if (count($errors) > 0)
                ...
                <form action="{{ route('wisata.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" id="sampul_wisata" name="sampul_wisata" placeholder="">
                                <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama_wisata" name="nama_wisata" placeholder="">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="wisata_foto[]">Foto 1</label>
                                <input type="text" class="form-control" id="wisata_foto[]" name="wisata_foto[]" placeholder="">
                                <small class="text-muted">Boleh dikosongkan</small>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="wisata_foto[]">Foto 2</label>
                                <input type="text" class="form-control" id="wisata_foto[]" name="wisata_foto[]" placeholder="">
                                <small class="text-muted">Boleh dikosongkan</small>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="wisata_foto[]">Foto 3</label>
                                <input type="text" class="form-control" id="wisata_foto[]" name="wisata_foto[]" placeholder="">
                                <small class="text-muted">Boleh dikosongkan</small>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="wisata_foto[]">Foto 4</label>
                                <input type="text" class="form-control" id="wisata_foto[]" name="wisata_foto[]" placeholder="">
                                <small class="text-muted">Boleh dikosongkan</small>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="wisata_foto[]">Foto 5</label>
                                <input type="text" class="form-control" id="wisata_foto[]" name="wisata_foto[]" placeholder="">
                                <small class="text-muted">Boleh dikosongkan</small>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="wisata_foto[]">Foto 6</label>
                                <input type="text" class="form-control" id="wisata_foto[]" name="wisata_foto[]" placeholder="">
                                <small class="text-muted">Boleh dikosongkan</small>
                            </div>
                        </div>
